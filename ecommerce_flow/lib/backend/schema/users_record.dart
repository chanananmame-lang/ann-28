...
class UsersRecord extends FirestoreRecord {
  ...
  // "cart_reference" field.
  DocumentReference? _cartReference;
  DocumentReference? get cartReference => _cartReference;
  bool hasCartReference() => _cartReference != null;
  ...
  void _initializeFields() {
    ...
    _cartReference = snapshotData['cart_reference'] as DocumentReference?;
  }
  ...
  Map<String, DebugDataField> toDebugSerializableMap() => {
        ...
        'cart_reference': debugSerializeParam(
          cartReference,
          ParamType.DocumentReference,
          link:
              'https://beta.flutterflow.io/project/ecommerce-flow-32g10t?tab=database',
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    return e1?.email == e2?.email &&
        ...
        e1?.cartReference == e2?.cartReference;
  }
